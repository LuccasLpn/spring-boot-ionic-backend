...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Luccas Pereira", "luccas.lpn@outlook.com", "36378912377", TipoCliente.PESSOAFISICA, passwordEncoder.encode("senha123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "luccas.lpnn@outlook.com", "96150504077", TipoCliente.PESSOAFISICA, passwordEncoder.encode("senha123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("11987151157", "67876752"));


		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Buriti Alegre", "647", null, "Vila Ré", "38777012", cli1, c2);
